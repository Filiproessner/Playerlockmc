...
public class AimGuiScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new SliderWidget(centerX - 100, centerY - 40, 200, 20,
                Text.of("Range: " + AimSettings.RANGE),
                AimSettings.RANGE / 50.0) {
            @Override
            protected void updateMessage() {
                this.setMessage(Text.of("Range: " + String.format("%.1f", AimSettings.RANGE)));
            }
        ...
        this.addDrawableChild(new SliderWidget(centerX - 100, centerY, 200, 20,
                Text.of("Smooth: " + AimSettings.SMOOTH),
                (AimSettings.SMOOTH - 0.05) / 0.95) {
            @Override
            protected void updateMessage() {
                this.setMessage(Text.of("Smooth: " + String.format("%.2f", AimSettings.SMOOTH)));
            }
